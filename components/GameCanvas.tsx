...
const ISO_DECOR_URL = 'data:image/png;base64,';
...
class GameScene extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.renderables = [];
        this.decorations = [];
        this.props = { state: null, onAgentClick: () => {}, selectedAgentId: null, onReady: () => {} };
    ...
    create() {
        ...
        // Beri sinyal bahwa scene sudah siap
        ...
        for (let y = 0; y < MAP_HEIGHT; y++) {
            for (let x = 0; x < MAP_WIDTH; x++) {
                ...
                if (tileIndex === 2 && Math.random() < 0.1) {
                    ...
                    // FIX: Tambahkan pemeriksaan defensif untuk memastikan sistem fisika tersedia sebelum digunakan.
                    if (this.box2d) {
    ...
    update() {
        ...
        this.props.state.agents.forEach(agentData => {
            ...
            if (!sprite) {
                ...
                // FIX: Tambahkan pemeriksaan defensif untuk memastikan sistem fisika tersedia.
                if (this.box2d) {
                    this.box2d.add.existing(sprite, { shape: 'circle', radius: 8 });
                }
                
                // Safely configure the physics body
                if (sprite.body) {
...
const GameCanvas: React.FC<GameCanvasProps> = ({ state, onAgentClick, selectedAgentId, onReady }) => {
  ...
  useEffect(() => {
    if (gameRef.current && gameRef.current.scene.isActive('GameScene')) {
        ...
        scene.updateProps({ state, onAgentClick, selectedAgentId, onReady });
    }
  }, [state, onAgentClick, selectedAgentId, onReady]);
